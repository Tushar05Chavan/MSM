...
//
//     final formInstitutionResponseModel = formInstitutionResponseModelFromJson(jsonString);

import 'dart:convert';

List<FormInstitutionResponseModel> formInstitutionResponseModelFromJson(
        String str) =>
    List<FormInstitutionResponseModel>.from(
        json.decode(str).map((x) => FormInstitutionResponseModel.fromJson(x)));

String formInstitutionResponseModelToJson(
        List<FormInstitutionResponseModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class FormInstitutionResponseModel {
  FormInstitutionResponseModel({
    this.instName,
    this.instAlias,
    this.instLogoPath,
    this.instImagePath,
  ...
  factory FormInstitutionResponseModel.fromJson(Map<String, dynamic> json) =>
      FormInstitutionResponseModel(
