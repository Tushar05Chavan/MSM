...
List<GetNotesResponseModel> getNotesResponseModelFromJson(String str) =>
    List<GetNotesResponseModel>.from(
        json.decode(str).map((x) => GetNotesResponseModel.fromJson(x)));

String getNotesResponseModelToJson(List<GetNotesResponseModel> data) =>
...
class GetNotesResponseModel {
  ...
  factory GetNotesResponseModel.fromJson(Map<String, dynamic> json) =>
      GetNotesResponseModel(
