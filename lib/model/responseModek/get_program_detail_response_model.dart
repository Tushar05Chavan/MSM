...
//
//     final getProgramDetailResponseModel = getProgramDetailResponseModelFromJson(jsonString);

import 'dart:convert';

GetProgramDetailResponseModel getProgramDetailResponseModelFromJson(
        String str) =>
    GetProgramDetailResponseModel.fromJson(json.decode(str));

String getProgramDetailResponseModelToJson(
        GetProgramDetailResponseModel data) =>
    json.encode(data.toJson());

class GetProgramDetailResponseModel {
  GetProgramDetailResponseModel({
    this.programId,
    this.programName,
    this.programStatus,
    this.durationTime,
  ...
  dynamic globalRank;
  dynamic localRank;
  dynamic instituteAbout;
  dynamic instAddress;
  dynamic programDuration;
  dynamic applicationFee;
  dynamic instTile;
  dynamic instCountryId;
  ...
  int? offCampus;
  int? homeStay;
  int? postGraduateWithWork;
  int? programWithCoOpOption;
  int? conditionalOfferLetter;
  int? workWhileStudy;
  int? institutionId;
  int? partnerTypeId;
  List<Intek>? inteks;
  ...
  dynamic additionalRequirement;

  factory GetProgramDetailResponseModel.fromJson(Map<String, dynamic> json) =>
      GetProgramDetailResponseModel(
