...
//
//     final scholarshipMoreDetailResponseModel = scholarshipMoreDetailResponseModelFromJson(jsonString);

import 'dart:convert';

List<ScholarshipMoreDetailResponseModel>
    scholarshipMoreDetailResponseModelFromJson(String str) =>
        List<ScholarshipMoreDetailResponseModel>.from(json
            .decode(str)
            .map((x) => ScholarshipMoreDetailResponseModel.fromJson(x)));

String scholarshipMoreDetailResponseModelToJson(
        List<ScholarshipMoreDetailResponseModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ScholarshipMoreDetailResponseModel {
  ...
  factory ScholarshipMoreDetailResponseModel.fromJson(
