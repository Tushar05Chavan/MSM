...
class _RefundTrackerScreenState extends State<RefundTrackerScreen> {
  ...
  Future<void> getIntake() async {
    await _commissionIntakeDropdownViewModel.commissionIntakeDropdownViewModel(
        instituteId: int.parse(_selectedInstitution.toString()));
                        ...
                        DropdownButtonHideUnderline(
                          child: DropdownButtonHideUnderline(
                            child: DropdownButtonFormField(
                                ...
                                items: intakes.map((intakes) {
                                  return DropdownMenuItem(
                                      value: intakes.intakeName.toString(),
                                      child: Text(
                                        intakes.intakeName.toString(),
                                        style: const TextStyle(
                                            color: kGrey4,
                                            fontFamily: "Roboto",
                                            fontSize: 13),
