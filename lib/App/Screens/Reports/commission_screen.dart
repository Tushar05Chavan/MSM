...
import 'package:msm_unify/viewModel/commission_advance_view_model.dart';
import 'package:msm_unify/viewModel/commission_institution_view_model.dart';

import '../../../model/responseModek/commission_institution_response_model.dart';
import '../../../model/responseModek/commission_intake_dropdown_response_model.dart';
import 'widget/institution_dropdown.dart';

class ReportCommission extends StatefulWidget {
  const ReportCommission({Key? key}) : super(key: key);

  @override
  State<ReportCommission> createState() => _ReportCommissionState();
}

class _ReportCommissionState extends State<ReportCommission> {
  ...
  final CommissionAdvanceViewModel _commissionAdvanceViewModel =
      Get.put(CommissionAdvanceViewModel());
                          ...
                          _advance == false
                              ? Column(
                                  children: [
                                    ...
                                    GetBuilder<CommissionAdvanceViewModel>(
                                      builder: (controller) {
                                        if (controller.apiResponse.status ==
                                            Status.COMPLETE) {
                                          cr.CommissionAdvanceResponseModel
                                              response =
...
class TableRow extends DataTableSource {
  final cr.CommissionAdvanceResponseModel res;
    ...
    return DataRow(cells: [
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].firstName}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].middleName}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].lastName}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].program}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].depositDate}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].studentId}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].feeDeposit}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].commission}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].importFeeAmount}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].importCommissionAmount}'),
        ),
      ),
      DataCell(
        Container(
      ...
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].invoiceNumber}'),
        ),
      ),
      DataCell(
        Container(
          ...
          child: Text('${res.data![index].enrollmentRemark}'),
        ),
      ),
    ]);
  }
  ...
  @override
  int get rowCount => res.data!.length;
