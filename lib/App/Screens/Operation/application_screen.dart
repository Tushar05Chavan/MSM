...
class _ApplicationScreenState extends State<ApplicationScreen> {
  ...
  Future<void> createExcel() async {
    ...
    sheet.getRangeByName('A1').setText('Application ID');
    sheet.getRangeByName('B1').setText('Status');
    sheet.getRangeByName('C1').setText('First Name');
    sheet.getRangeByName('D1').setText('Last Name');
    sheet.getRangeByName('E1').setText('Create Date');
    sheet.getRangeByName('F1').setText('Submit Date');
    sheet.getRangeByName('G1').setText('Institution Name');
    sheet.getRangeByName('H1').setText('Contact Number');
    sheet.getRangeByName('I1').setText('Document Status');
                                    ...
                                    onTap: () async {
                                      ...
                                      for (var i = 0; i < data[0]; i++) {
                                        sheet
                                            ...
                                            .setValue(
                                                resp.data![i].applicationId);
                                        sheet
                                            .getRangeByIndex(i + 2, 2)
                                            .setValue(resp.data![i].statusName);
                                        sheet
                                        ...
                                        sheet
                                            ...
                                            .setValue(
                                                resp.data![i].applicationDate);
                                        sheet
                                            .getRangeByIndex(i + 2, 6)
                                            .setValue(resp.data![i].submitDate);
                                        sheet
                                            .getRangeByIndex(i + 2, 7)
                                            .setValue(resp.data![i].instName);
                                        sheet
                                            .getRangeByIndex(i + 2, 8)
                                            .setValue(
                                                resp.data![i].contactNumber);
                                        sheet
                                            .getRangeByIndex(i + 2, 9)
                                            .setValue(
                                                resp.data![i].documentsStatus);
                                      }
///////////////////////////////////
                              ...
                              PaginatedDataTable(
                                  ...
                                  source:
                                      TableRow(BuildContext: context, resp)),
                              Padding(
                                padding:
